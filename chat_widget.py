...
class ChatWidget(
    ...
    def build_ui(
        ...
        # Dark theme styling for chat display
    ...
    def connect_to_channel(
        ...
        # Use provided channel (from ChatPanel) or read from input field
        if channel is None:
            channel = (
        ...
        # DO NOT update status - it no longer exists
        # self.status.setText(f"Connecting to #{channel}...")
    ...
    def chat_connected(
        ...
        # DO NOT update status - it no longer exists
        # self.status.setText(f"🟢 Connected to #{self.current_channel}")
        pass
    ...
    def chat_authentication_failed(
        ...
        # DO NOT update status - it no longer exists
        # self.status.setText("🔴 Twitch authentication failed")
    ...
    def chat_disconnected(
        ...
        # DO NOT update status - it no longer exists
        # self.status.setText("Chat disconnected")
        pass
